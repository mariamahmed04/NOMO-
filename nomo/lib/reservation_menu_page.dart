// ✅ ReservationMenuPage - Updated Version
...
class ReservationMenuPage extends StatefulWidget {
  final String restaurantId;
  const ReservationMenuPage({super.key, required this.restaurantId});

  @override
  State<ReservationMenuPage> createState() => _ReservationMenuPageState();
}

class _ReservationMenuPageState extends State<ReservationMenuPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 1,
        title: const Text('Reservation Menu', style: TextStyle(color: Colors.black)),
        ...
        actions: [
          ScaleTransition(
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.pushNamed(context, '/cart', arguments: {'type': 'reservation'});
              },
            ),
          )
        ],
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => ReservationPage(restaurantId: widget.restaurantId),
              ),
            );
          },
...
class _MenuItemCardState extends State<_MenuItemCard> {
  ...
  Future<void> addToCart() async {
    ...
    await FirebaseFirestore.instance.collection('carts').doc('${user.uid}_dine-in').delete().catchError((_) {});
    await FirebaseFirestore.instance.collection('carts').doc('${user.uid}_grab-go').delete().catchError((_) {});

    final cartId = '${user.uid}_reservation';
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('${widget.item['name']} added to reservation cart')),
    );
