...
class DineInMenuPage extends StatefulWidget {
  ...
  const DineInMenuPage({super.key, required this.restaurantId});

  @override
  State<DineInMenuPage> createState() => _DineInMenuPageState();
}

class _DineInMenuPageState extends State<DineInMenuPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 1,
        title: const Text('Dine-in Menu', style: TextStyle(color: Colors.black)),
        ...
        actions: [
          ScaleTransition(
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.pushNamed(context, '/cart', arguments: {'type': 'dine-in'});
              },
            ),
          )
        ],
...
class _MenuItemCardState extends State<_MenuItemCard> {
  ...
  Future<void> addToCart() async {
    ...
    await FirebaseFirestore.instance
        .collection('carts')
        .doc('${user.uid}_grab-go')
        .delete()
        .catchError((_) {});

    final cartId = '${user.uid}_dine-in';
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text(
                  ...
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.white, // Button text explicitly black
                  ),
                ),
              )
            ],
